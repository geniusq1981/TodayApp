var calPage = (function() {
    ...
    calPagePlugin.prototype = {
        ...
        renderdatedetail: function() {
            ...
            document.getElementById("calndate").innerHTML = Calcore.getCDate();

            var YJdata = Calcore.getYJ();
            document.getElementById("YHuangli").innerHTML = YJdata[0] + " , " + YJdata[1] + " , " + YJdata[2];
            document.getElementById("NHuangli").innerHTML = YJdata[3] + " , " + YJdata[4] + " , " + YJdata[5];
